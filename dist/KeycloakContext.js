...
exports.CONTEXT_KEY = 'kauth';
class KeycloakContextBase {
    constructor(token) {
...
exports.KeycloakContextBase = KeycloakContextBase;
KeycloakContextBase.contextKey = exports.CONTEXT_KEY;
/**
 ...
 *
 */
class KeycloakContext extends KeycloakContextBase {
    constructor({ req }) {
 ...
 * ```
 */
class KeycloakSubscriptionContext extends KeycloakContextBase {
    /**
     *
...
exports.KeycloakSubscriptionContext = KeycloakSubscriptionContext;
