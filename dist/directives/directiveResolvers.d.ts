 ...
 *
 */
export declare const auth: (next: Function) => (root: any, args: any, context: any, info: any) => any;
/**
 *
 ...
 * ```
 */
export declare const hasRole: (roles: string[]) => (next: Function) => (root: any, args: any, context: any, info: any) => any;
